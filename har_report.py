...
print(f"DNS lookup (average)              : {avg(dns_values)} ms")
print(f"TCP connect (average)             : {avg(tcp_values)} ms")
print(f"SSL/TLS handshake (average)       : {avg(ssl_values)} ms")
print(f"SAP IAS response (average)        : {avg(ias_response)} ms")
print(f"Okta redirect (average)           : {avg(okta_response)} ms")
print(f"Launchpad callback (average)      : {avg(callback_response)} ms")
